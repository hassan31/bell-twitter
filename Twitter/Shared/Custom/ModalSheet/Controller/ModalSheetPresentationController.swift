...
class ModalSheetPresentationController : UIPresentationController {
    ...
    // MARK: - Initialization
    /** This is your initialization method that will initialize the pan gesture
     */
...
protocol ModalSheetPresentable { }

extension ModalSheetPresentable where Self: UIViewController {
    func maximizeToFullScreen() -> Void {
        if let presetation = presentationController as? ModalSheetPresentationController {
            presetation.changeScale(to: .adjustedOnce)
        }
    }
}

extension ModalSheetPresentable where Self: UINavigationController {
    func isHalfModalMaximized() -> Bool {
        if let presentationController = presentationController as? ModalSheetPresentationController {
